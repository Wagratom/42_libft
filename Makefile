...
#    Updated: 2022/09/13 19:24:13 by wwallas-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		=	ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
				...
				ft_substr.c ft_tolower.c ft_toupper.c ft_get_next_line.c free_ptr.c        \
				numb_house.c ft_is_int_nbr.c ft_array_len.c ft_array_dup.c
